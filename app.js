...
function renderCardRow(container, card) {
    ...
    if (card.id === 'squeeker' || card.id === 'wildBoar' || card.id === 'steinbock' || card.id === 'chamoisDouglasFir' || card.id === 'chamoisEuropeanLarch' || card.id === 'chamoisStonePine' || card.id === 'wildBoarFemale' || card.id === 'squeekerWildlandEdge' || card.id === 'europeanBison') catKey = 'clovenHoofedAnimal';
